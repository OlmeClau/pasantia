...
class ActividadsControllerTest < ActionController::TestCase
  ...
  test "should create actividad" do
    assert_difference('Actividad.count') do
      post :create, actividad: { at_date: @actividad.at_date, description: @actividad.description, place: @actividad.place, tittle: @actividad.tittle }
    end
  ...
  test "should update actividad" do
    patch :update, id: @actividad, actividad: { at_date: @actividad.at_date, description: @actividad.description, place: @actividad.place, tittle: @actividad.tittle }
    assert_redirected_to actividad_path(assigns(:actividad))
  end
